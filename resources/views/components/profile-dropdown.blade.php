<div x-data="{open: false}" class="relative">
    ...
    <div x-show="open" @click.away="open = false" class="absolute z-10 top-0 right-0 mt-8 bg-gray-100 shadow-lg rounded-md text-left border border-gray-200 w-32 dark:bg-gray-700 dark:border-gray-600">
        <a href="/profile/{{ auth()->user()->nickname }}" class=" font-medium text-md block px-4 py-2 border-b border-gray-200 hover:text-gray-800 hover:bg-white rounded-t-md dark:hover:text-gray-50 dark:hover:bg-gray-600 dark:text-gray-50 dark:border-gray-500">Profile</a>
